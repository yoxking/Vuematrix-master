  ...
  <a-card>
    ...
    <div>
      <div class="operator">
        <a-button
          @click="handlePrint"
          v-hasPermit="['process:goodsprint:print']"
          type="primary"
        >打印</a-button>
        <a-dropdown>
          <a-menu
          ...
          >
            <a-menu-item
              key="audit"
              v-hasPermit="['process:goodsprint:audit']"
            >审批</a-menu-item>
            <a-menu-item
              key="import"
              v-hasPermit="['process:goodsprint:import']"
            >导入</a-menu-item>
            <a-menu-item
              key="export"
              v-hasPermit="['process:goodsprint:export']"
            >导出</a-menu-item>
          </a-menu>
          <a-button>
            更多操作
        ...
        <vxe-table-column title="操作">
          <template v-slot="{ row }">
            <vxe-button
              ...
              v-hasPermit="['process:goodsprint:detail']"
            >详细</vxe-button>
          </template>
        </vxe-table-column>
      </vxe-table>
...
<script>
import { listGoodsprint, exptGoodsprint } from '@/api/process/goodsprint'
  ...
  methods: {
    ...
    handleMenu (e) {
      ...
      if (e.key === 'audit') {
        ...
        exptGoodsprint(this.pageParam).then(response => {
    ...
    getDataSource () {
      const that = this
      this.loading = true
      listGoodsprint(this.pageParam).then(response => {
