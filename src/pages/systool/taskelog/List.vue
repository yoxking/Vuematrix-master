  ...
  <a-card>
    ...
    <div>
      <div class="operator">
        <a-button
          @click="handleDel"
          v-hasPermit="['system:taskelog:delete']"
        >删除</a-button>
        <a-dropdown>
          <a-menu
            @click="handleMenu"
          ...
          >
            <a-menu-item
              key="audit"
              v-hasPermit="['system:taskelog:audit']"
            >审批</a-menu-item>
            <a-menu-item
              key="import"
              v-hasPermit="['system:taskelog:import']"
            >导入</a-menu-item>
            <a-menu-item
              key="export"
              v-hasPermit="['system:taskelog:export']"
            >导出</a-menu-item>
          </a-menu>
          <a-button>
            更多操作
      ...
      >
        ...
        <vxe-table-column title="操作">
          <template v-slot="{ row }">
            <vxe-button
              type="text"
              v-hasPermit="['system:taskelog:detail']"
              @click="handleDet(row.taskLogno)"
            >详细</vxe-button>
          </template>
        </vxe-table-column>
      </vxe-table>
