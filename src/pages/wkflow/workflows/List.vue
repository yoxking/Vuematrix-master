  ...
  <a-card>
    ...
    <div>
      <div class="operator">
        <a-button
          @click="handleAdd"
          v-hasPermit="['wkflow:workflows:addnew']"
          type="primary"
        >新增</a-button>
        <a-button
          @click="handleDel"
          v-hasPermit="['wkflow:workflows:delete']"
        >删除</a-button>
        <a-dropdown>
          <a-menu
            @click="handleMenu"
          ...
          >
            <a-menu-item
              key="audit"
              v-hasPermit="['wkflow:workflows:audit']"
            >审批</a-menu-item>
            <a-menu-item
              key="import"
              v-hasPermit="['wkflow:workflows:import']"
            >导入</a-menu-item>
            <a-menu-item
              key="export"
              v-hasPermit="['wkflow:workflows:export']"
            >导出</a-menu-item>
          </a-menu>
          <a-button>
            更多操作
      ...
      >
        ...
        >
          <template v-slot="{ row }">
            <vxe-button
              type="text"
              @click="designFlow(row.flowNo)"
              v-hasPermit="['wkflow:workflows:dflow']"
            >设计流程</vxe-button>
            <vxe-button
              type="text"
              @click="handleEdt(row.flowNo)"
              v-hasPermit="['wkflow:workflows:update']"
            >编辑</vxe-button>
            <vxe-button
              type="text"
              @click="handleDet(row.flowNo)"
              v-hasPermit="['wkflow:workflows:detail']"
            >详细</vxe-button>
          </template>
        </vxe-table-column>
      </vxe-table>
