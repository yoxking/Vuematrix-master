  ...
  <a-card>
    ...
    <div>
      <div class="operator">
        <a-button
          @click="handleDel"
          v-hasPermit="['system:operatelog:delete']"
        >删除</a-button>
        <a-dropdown>
          <a-menu
            @click="handleMenu"
          ...
          >
            <a-menu-item
              key="audit"
              v-hasPermit="['system:operatelog:audit']"
            >审批</a-menu-item>
            <a-menu-item
              key="import"
              v-hasPermit="['system:operatelog:import']"
            >导入</a-menu-item>
            <a-menu-item
              key="export"
              v-hasPermit="['system:operatelog:export']"
            >导出</a-menu-item>
          </a-menu>
          <a-button>
            更多操作
      ...
      >
        ...
        <vxe-table-column title="操作">
          <template v-slot="{ row }">
            <vxe-button
              type="text"
              @click="handleDet(row.oplogNo)"
              v-hasPermit="['system:operatelog:detail']"
            >详细</vxe-button>
          </template>
        </vxe-table-column>
      </vxe-table>
