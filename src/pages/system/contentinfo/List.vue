<template>
  <a-card>
    ...
    <div>
      <div class="operator">
        <a-button @click="handleAdd" v-hasPermit="['system:contentinfo:addnew']" type="primary">新增</a-button>
        <a-button @click="handleDel" v-hasPermit="['system:contentinfo:delete']">删除</a-button>
        <a-dropdown>
          <a-menu @click="handleMenu"
                  slot="overlay">
            <a-menu-item key="audit" v-hasPermit="['system:contentinfo:audit']">审批</a-menu-item>
            <a-menu-item key="import" v-hasPermit="['system:contentinfo:import']">导入</a-menu-item>
            <a-menu-item key="export" v-hasPermit="['system:contentinfo:export']">导出</a-menu-item>
          </a-menu>
          <a-button>
            更多操作
            <a-icon type="down" />
        ...
        <vxe-table-column title="操作">
          <template v-slot="{ row }">
            <vxe-button type="text"
                        @click="handleEdt(row.contzNo)" v-hasPermit="['system:contentinfo:update']">编辑</vxe-button>
            <vxe-button type="text"
                        @click="handleDet(row.contzNo)" v-hasPermit="['system:contentinfo:detail']">详细</vxe-button>
          </template>
        </vxe-table-column>
      </vxe-table>
      <vxe-pager border
...
<script>
import { listContentinfo, delContentinfo, exptContentinfo } from '@/api/system/contentinfo'
