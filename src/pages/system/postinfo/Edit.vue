      ...
      <a-row>
        <a-col :span="spanCol">
          <a-form-model-item label="编号"
                             prop="postNo"
                             ref="postNo">
            <a-input v-model="form.postNo" readOnly/>
          </a-form-model-item>
        </a-col>
        <a-col :span="spanCol">
          &nbsp;
      ...
      <a-row>
        <a-col :span="spanCol">
          <a-form-model-item label="岗位名称"
                             prop="postName"
                             ref="postName">
            <a-input v-model="form.postName" />
          </a-form-model-item>
        </a-col>
        <a-col :span="spanCol">
          <a-form-model-item label="岗位编码"
                             prop="postCode"
                             ref="postCode">
...
<script>
import { getPostinfo, addPostinfo, uptPostinfo } from '@/api/system/postinfo'
